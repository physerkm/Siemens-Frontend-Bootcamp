...
@NgModule({
  declarations: [AppComponent, InlineComponent, NormalComponent, StructuralDirectiveComponent, ExampleComponent, CustomDirective, ExamplePipeComponent, CustomUppercasePipe],
